...
export const ProductAddToCart = styled(Button)((show, theme) => ({
    ...
    [theme.breakpoints.up('md')]: {
        ...
        animation: 
            show && 
        `${slideInBottom} 0.5 cubic-bezier(0.250, 0.460, 0.450, 0.940) both`
    },
...
export const ProductActionsWrapper = styled(Box)(({ show, theme }) => ({
    [theme.breakpoints.up('md')]: {
        ...
        right: 0,
        top: '20%',
        animation: show && `${slideInRight} 0.5 cubic-bezier(0.250, 0.460, 0.450, 0.940) both`
    }
}));